...
public class RestListTIFSourceConfigsAction extends BaseRestHandler {
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        SAListTIFSourceConfigsRequest req = new SAListTIFSourceConfigsRequest(searchRequest);
...
//                TIFSourceConfig detector = TIFSourceConfigDto.docParse(xcp, hit.getId(), hit.getVersion());
