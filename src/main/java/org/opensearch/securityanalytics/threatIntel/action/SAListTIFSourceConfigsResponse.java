...
public class SAListTIFSourceConfigsResponse extends ActionResponse implements ToXContentObject {
    ...
    public SAListTIFSourceConfigsResponse(List<SATIFSourceConfigDto> SaTifSourceConfigDtos) {
        super();
        this.SaTifSourceConfigDtos = SaTifSourceConfigDtos;
    }

    public SAListTIFSourceConfigsResponse(StreamInput sin) throws IOException {
        this(
